...
os.chdir("/media/kafkan/storage1/SeqSleepNetExtension/extending_recurrent/lrrt/cnn/logdata")
#%%
...
plot_lrrt("trainLoss_cnn_epoch_wd", lr2, high_lr = 2, lim=[6e-4,0.002])


#%% constant placebo unfrozen

plot_lrrt("trainLoss_cnn_sequence_wd", lr2, high_lr = 2, loc="upper left")
