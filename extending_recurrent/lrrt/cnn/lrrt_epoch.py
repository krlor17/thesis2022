...
params = {'L': L,
      ...
      'dropOutEncoder': DROPOUT_RATE_ENCODER,      
...
encoder = CNNEncoder(latent_dim=LATENT_DIM, cal_shape=(129,188), dropout_rate=DROPOUT_RATE_ENCODER)
model = EpochwiseExtension(encoder,
                             base_lr = LOW_LR,
