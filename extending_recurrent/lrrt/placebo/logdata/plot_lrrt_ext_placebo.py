...
os.chdir("/media/kafkan/storage1/SeqSleepNetExtension/extending_recurrent/lrrt/placebo/logdata")
#%%
...
def plot_lrrt(base_name, lr, high_lr=2, low_lr=1e-5, loc = "best" ):
...
plot_lrrt("trainLoss_constant_epoch_wd", lr2, high_lr = 2, loc="upper left")


#%% constant placebo unfrozen

plot_lrrt("trainLoss_constant_sequence_wd", lr2, high_lr = 2)

#%% alpha frozen

plot_lrrt("trainLoss_random_epoch_wd", lr2, high_lr = 2)

#%% 

plot_lrrt("trainLoss_random_sequence_wd", lr2, high_lr = 2)