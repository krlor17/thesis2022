...
from epoch_rec_extension import EpochwiseExtension
...
def init_func(sampler):
    ...
    return EpochwiseExtension(encoder, base_lr, lr_schedule, schedule_args, weight_decay=WEIGHT_DECAY, dropout_rate=DROPOUT_RATE_BASE)


model_class = EpochwiseExtension
exp_name = "epoch-extension-constant"

SAVE_DIR = f"/home/au709601/NOBACKUP/SeqSleepNetExtension/extending_recurrent/cross_validate/placebo/rundata/{exp_name}"
