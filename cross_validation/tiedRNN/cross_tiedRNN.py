...
def init_func(sampler):
    ...
    encoder = TiedRNNEncoder(LATENT_DIM, cal_shape=(129,188), base=base)
...
exp_name = "tiedRNN-unfrozen"

SAVE_DIR = "/home/au709601/NOBACKUP/SeqSleepNetExtension/cross_validation/tiedRNN/rundata"
