...
# MODEL_PATH = "../checkpoints/tiedRNN-frozen/epoch=14-valKappa=0.8556.ckpt" # frozen
MODEL_PATH = "../checkpoints/tiedRNN-unfrozen/epoch=81-valKappa=0.8703.ckpt" #unfrozen
