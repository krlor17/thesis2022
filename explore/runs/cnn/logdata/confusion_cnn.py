...
MODEL_PATH = "../checkpoints/cnn/epoch=57-valKappa=0.8516.ckpt"
# MODEL_PATH = "../checkpoints/tiedRNN/epoch=14-valKappa=0.8539-v1.ckpt"
# MODEL_PATH = "../checkpoints/tiedRNN/epoch=4-valKappa=0.8537.ckpt"

#
model = ExploratoryExtension.load_from_checkpoint(MODEL_PATH, base=base)
...
MODEL_PATH = "../checkpoints/cnn-unfrozen/epoch=60-valKappa=0.8629.ckpt"
# MODEL_PATH = "../checkpoints/tiedRNN/epoch=14-valKappa=0.8539-v1.ckpt"
# MODEL_PATH = "../checkpoints/tiedRNN/epoch=4-valKappa=0.8537.ckpt"
