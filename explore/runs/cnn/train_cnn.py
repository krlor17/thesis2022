...
HIGH_LR = 0.4  # 0.4 for 1e-4 unfrozen, 0.75 for 1e-4 frozen
LOW_LR = HIGH_LR/10
BATCH_SIZE = 32
DROPOUT_RATE = 0.0
...
encoder = CNNEncoder(latent_dim=LATENT_DIM, cal_shape=(129,188), dropout_rate=DROPOUT_RATE)
