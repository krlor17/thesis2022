...
encoder = ConstantPlaceboEncoder(16, cal_shape=(188,129))
# MODEL_PATH = "../checkpoints/constant_placebo/epoch=36-step=3477.ckpt"
# MODEL_PATH = "../checkpoints/constant_placebo/epoch=10-step=1033.ckpt"
# MODEL_PATH = "../checkpoints/constant_placebo/epoch=20-step=1973.ckpt"
# MODEL_PATH = "../checkpoints/constant_placebo/epoch=47-step=4511.ckpt"
# MODEL_PATH = "../checkpoints/constant_placebo_seeded/lr025seed97.ckpt"

MODEL_PATH = "../checkpoints/constant_placebo_frozen/epoch=38-step=3665.ckpt"
# MODEL_PATH = "../checkpoints/constant_placebo_unfrozen/epoch=59-step=5639.ckpt"


model = ExploratoryExtension.load_from_checkpoint(MODEL_PATH, base=base, encoder=encoder)
...
encoder = RandomPlaceboEncoder(16, cal_shape=(188,129))
# MODEL_PATH = "../checkpoints/random_placebo/epoch=22-step=2161.ckpt"
MODEL_PATH = "../checkpoints/random_placebo/epoch=27-step=2631.ckpt"
# MODEL_PATH = "../checkpoints/random_placebo/epoch=5-step=563.ckpt"
MODEL_PATH = "../checkpoints/random_placebo_unfrozen/epochepoch=76-kappavalKappa=0.8694.ckpt"
