...
val_kappa_lr050 = np.loadtxt("valKappa_random_lr050.csv", skiprows = 1, delimiter=",")[:,2]
val_kappa_lr025 = np.loadtxt("valKappa_random_lr025.csv", skiprows = 1, delimiter=",")[:,2]
val_kappa_lr0125 = np.loadtxt("valKappa_random_lr0125.csv", skiprows = 1, delimiter=",")[:,2]

# val_loss_lr050 = np.loadtxt("valLoss_random_lr050.csv", skiprows = 1, delimiter=",")[:,2]
# val_loss_lr025 = np.loadtxt("valLoss_random_lr025.csv", skiprows = 1, delimiter=",")[:,2]
# val_loss_lr0125 = np.loadtxt("valLoss_random_lr0125.csv", skiprows = 1, delimiter=",")[:,2]

train_kappa_lr050 = np.loadtxt("trainKappa_random_lr050.csv", skiprows = 1, delimiter=",")[:,2]
# train_kappa_lr025 = np.loadtxt("trainKappa_random_lr025.csv", skiprows = 1, delimiter=",")[:,2]
# train_kappa_lr0125 = np.loadtxt("trainKappa_random_lr0125.csv", skiprows = 1, delimiter=",")[:,2]

# train_loss_lr050 = np.loadtxt("trainLoss_random_lr050.csv", skiprows = 1, delimiter=",")[:,2]
# train_loss_lr025 = np.loadtxt("trainLoss_random_lr025.csv", skiprows = 1, delimiter=",")[:,2]
# train_loss_lr0125 = np.loadtxt("trainLoss_random_lr0125.csv", skiprows = 1, delimiter=",")[:,2]

train_kappa_unfrozen = np.loadtxt("trainKappa_random_unfrozen.csv", skiprows = 1, delimiter=",")[:,2]
val_kappa_unfrozen = np.loadtxt("valKappa_random_unfrozen.csv", skiprows = 1, delimiter=",")[:,2]

#%% random - Max. kappa vs. 
# BASE_NAME = "valKappa_random_lr"
...
steps = np.arange(len(val_kappa_lr0125))
