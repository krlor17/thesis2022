...
os.chdir("/media/kafkan/storage1/SeqSleepNetExtension/explore/lrrt/cnn/logdata/")
#%%
...
lr_table= np.loadtxt("lr_3.csv", skiprows = 1, delimiter=",")
...
#%%
BASE_NAME = "trainLoss_cnn-unfrozen_wd"
