...
# -*- coding: utf-8 -*-
"""
Learning Rate Range Test for Exploratory extension with random placebo encoder
...
expName="lrrt-constant-placebo-frozen"
params = {'L': L,
...
encoder = ConstantPlaceboEncoder(latent_dim=LATENT_DIM, cal_shape=(188,129))
