...
os.chdir("/media/kafkan/storage1/SeqSleepNetExtension/explore/lrrt/placebo/logdata")
#%%
...
lr3_table= np.loadtxt("lr3.csv", skiprows = 1, delimiter=",")
...
#%% constant placebo frozen

plot_lrrt("trainLoss_const_frozen_wd", lr3, high_lr = 3)


#%% constant placebo unfrozen

plot_lrrt("trainLoss_const_unfrozen_wd", lr3, high_lr = 2)

#%% alpha frozen

plot_lrrt("trainLoss_rand_frozen_wd", lr2, high_lr = 2)

#%% 

plot_lrrt("trainLoss_rand_unfrozen_wd", lr2, high_lr = 2)